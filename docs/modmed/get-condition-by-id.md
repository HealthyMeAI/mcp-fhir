...
Retrieves specific Condition resource by ID.
...
## Response
Returns FHIR Condition resource in JSON format.
...
```bash
curl --request GET \
     --url https://stage.ema-api.com/ema-dev/firm/apiportal/ema/fhir/v2/Condition/ \
     --header 'accept: application/fhir+json'
```

---

*Reference: https://portal.api.modmed.com/reference/get_fhir-v2-condition-id*
